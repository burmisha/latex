        ...
        tasks = {
            ...
            '5-03': (
                r'''
                    ...
                    (все электроны, выбитые из катода в единицу времени, достигают анода) $\eli_{\text{н}} = 4\\units{мА}$. Какое количество $n$ фотонов приходится на один электрон, выбиваемый из катода?
