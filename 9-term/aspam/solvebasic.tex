...
При этом функция Лагранжа также принимает вид 
\begin{equation}
\newcommand\ai[0]{\alpha_i\,}
\newcommand\aj[0]{\alpha_j\,}
\newcommand\mbx[1]{\mb x_#1}
...
Решая задачу квадратичной максимизации, но уже без ограничения $\sum_i\alpha_i = 1,$ аналогично получим вектор $\alpha$, 
