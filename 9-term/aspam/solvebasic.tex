...
\begin{equation}
			...
			&\norm{\mb x_i-\mb a}^2\le R^2 + \delta_i,\quad\delta_i\ge0,\quad i = 1,\ldots,N.
			} 
\end{equation}
...
\al{
L(\mb a, R,\mb\xi,\mb\alpha,\mb\gamma)
	&= 	R^2 - \suml_i\ai R^2 + C\suml_i\xi_i - \suml_i\ai\delta_i 
	+ 	\suml_i\ai\mbx i\cd\mbx i - \\
	&- 2\suml_i\ai\mb a\cd\mbx i + \suml_i\ai\mb a\cd\mb a +\suml_i\gamma_i\delta_i =\\
