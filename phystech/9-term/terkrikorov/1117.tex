...
$Ax + f(x) = 0$
\al{
	e_1, e_2, \ldots e_n &\text{ --- базис в } N(T), T=A - f'(x_0)\cbr{\quad} \\
	e^*_1, e^*_2, \ldots e^*_n &\text{ --- биортогональный базис }\\
	\eps^*_1, \eps^*_2, \ldots \eps^*_n &\text{ --- биортогональный базис в} N(T^*) \\
	\eps_1, \eps_2, \ldots \eps_n &\text{ --- биортогональный базис }\\
}
