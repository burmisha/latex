...
\newcommand\skipped[1]{ {\ensuremath{\text{\small{\sffamily Пропущено: #1 строки бесценных знаний} } } } }
...
\newcommand\ddn[3]{\frac{\partial^{#1}#2}{\partial#3^{#1}}}
\newcommand\dddn[3]{\frac{d^{#1}#2}{d#3^{#1}}}
...
\newcommand\defenition{\par{\sffamily{Определение.}}\par}