...
def run(args):
    ...
    schedule_items = client.get_schedule_items(from_date='2020-11-10', to_date='2020-12-06')
...
def populate_parser(parser):
    ...
    # parser.add_argument('-f', '--from-date', help='Search lessons from date', default=[])
    # parser.add_argument('-t', '--to-date', help='Search lessons to date', default=[])
