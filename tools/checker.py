...
def get_checkers():
    config = [
        ...
        ('2020.11.26 10АБ - Законы сохранения - 2', classes.variants.get_variant('2020.11.26 10'), [4, 6, 8]),
        ...
        ('2020.12.11 10АБ - Статика и гидростатика - 2', classes.variants.get_variant('2020.12.11 10'), [1.5, 2.5, 3.5]),
        ('2020.12.17 9М - Колебания и волны - 3', list('АВБАВБ') + [{'А': 0, 'Б': 0}] + list('ВАБ'), [6, 7, 8]),
        ('2021.04.15 10АБ - Электростатика - 1', classes.variants.get_variant('2021.04.15 10'), [2, 4, 6]),
        ('2021.04.16 9М - Строение атома - 1', classes.variants.get_variant('2021.04.16 9'), [4, 5, 6]),
    ]
