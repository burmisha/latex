...
def get_checkers():
    config = {
        ...
        '2020.11.06 10АБ - Тест по динамике - 6': (
            [5, {'-?5': 1, '6.73': 1}, '-?3.(2[67]|3|23|256)', 0, 80, 120, 18, 5],
            [3, 5, 7],
        ),
        '2020.11.12 9М - Динамика - 6': (
            list('АББВВ') + ['(0.5|1/2)', 2, 120, 2],
            [3, 5, 7],
        ),
        '2020.11.13 10АБ - Законы сохранения - 1': (
            list('АБАБВА') + [{8000: 2}, {'12.6': 2}, {10: 2}, {5: 2}],
            [5, 8, 11],
        ),
    }
