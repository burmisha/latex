...
def run(args):
    ...
    if args.run_extractor:
        extractor_configs = [
            ...
            (
                ...
                '2020-21 10AБ Физика',
                {
                    ...
                    '2-5':  '10-2-1.1 - Динамика - Неделя 1 - Материалы-1.pdf',
                    '6':    '10-2-1.2 - Динамика - Неделя 1 - Тест.pdf',
                    '7-10': '10-2-1.2 - Динамика - Неделя 1 - Материалы-2.pdf',
                    '6, 11-17': '10-2-1.3 - Динамика - Неделя 1 - Материалы-3.pdf',
                },
            ),
            (
                ...
                '2020-21 9М Физика',
                {
                    ...
                    '5-8':  '9-2-1.2 - Динамика - Неделя 1 - Материалы.pdf',
                },
            ),
        ]
        for source_file, destination_directory, config in extractor_configs:
            ...
            pdfExtractor.ExtractConfig(config)
