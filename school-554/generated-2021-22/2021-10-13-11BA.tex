...
\answer{%
    \begin{align*}
    \Delta F &= -\rho_0 g a^2 \Delta x,\Delta F = m\ddot x = \rho a^3 \ddot x\implies \rho a^3 \ddot x = -\rho_0 g a^2 \Delta x \implies \\
...
\tasknumber{14}%
\task{%
    Определите период колебаний системы (см.
    рис.
    на доске),
    для случая $n = \sqrt{2}$.
...
\tasknumber{11}%
\task{%
    Масса груза в пружинном маятнике равна $400\,\text{г}$, при этом период его колебаний равен $11{,}2\,\text{с}$.
...
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M - m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M - m}{M}}
            = T\sqrt{\frac{M - m}{M}} =  T\sqrt{1 - \frac{m}{M}} \approx 12{,}52\,\text{с}.
    $
}
\solutionspace{120pt}
...
\tasknumber{11}%
\task{%
    Масса груза в пружинном маятнике равна $500\,\text{г}$, при этом период его колебаний равен $11{,}2\,\text{с}$.
...
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M + m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M + m}{M}}
            = T\sqrt{\frac{M + m}{M}} =  T\sqrt{1 + \frac{m}{M}} \approx 11{,}75\,\text{с}.
    $
}
\solutionspace{120pt}
...
\tasknumber{11}%
\task{%
    Масса груза в пружинном маятнике равна $600\,\text{г}$, при этом период его колебаний равен $11{,}2\,\text{с}$.
    Груз утяжеляют на $50\,\text{г}$.
    Определите новый период колебаний маятника.
}
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M + m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M + m}{M}}
            = T\sqrt{\frac{M + m}{M}} =  T\sqrt{1 + \frac{m}{M}} \approx 11{,}66\,\text{с}.
    $
}
\solutionspace{120pt}
...
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M - m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M - m}{M}}
            = T\sqrt{\frac{M - m}{M}} =  T\sqrt{1 - \frac{m}{M}} \approx 12{,}77\,\text{с}.
    $
}
\solutionspace{120pt}
...
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M - m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M - m}{M}}
            = T\sqrt{\frac{M - m}{M}} =  T\sqrt{1 - \frac{m}{M}} \approx 13{,}13\,\text{с}.
    $
}
\solutionspace{120pt}
...
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M - m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M - m}{M}}
            = T\sqrt{\frac{M - m}{M}} =  T\sqrt{1 - \frac{m}{M}} \approx 11{,}88\,\text{с}.
    $
}
\solutionspace{120pt}
...
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M + m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M + m}{M}}
            = T\sqrt{\frac{M + m}{M}} =  T\sqrt{1 + \frac{m}{M}} \approx 12{,}27\,\text{с}.
    $
}
\solutionspace{120pt}
