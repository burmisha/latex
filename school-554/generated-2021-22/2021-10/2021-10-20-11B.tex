...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 16\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {26\,\text{c}}{6\,\text{c}}}\approx -8{,}0\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 14\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {25\,\text{c}}{2\,\text{c}}}\approx -14{,}0\,\text{см}.$
}
\solutionspace{80pt}
