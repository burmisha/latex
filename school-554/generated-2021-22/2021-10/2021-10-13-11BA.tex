...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 18\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {24\,\text{c}}{2\,\text{c}}}\approx 18\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 18\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {23\,\text{c}}{6\,\text{c}}}\approx 9\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $2 * A \frac{1}{2} = A \approx 4\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $T = \frac 1\nu \approx 125\,\text{мc}, T_1 = \frac T2 \approx 62{,}5\,\text{мc}, T_2 = T \approx 125\,\text{мc}, T_3 = \frac T2 \approx 62{,}5\,\text{мc}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 16\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {23\,\text{c}}{6\,\text{c}}}\approx 8\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 18\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {21\,\text{c}}{2\,\text{c}}}\approx -18\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $2 * A \frac{1}{2} = A \approx 6\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $2 * A \frac{1}{12} = \frac{A:L:s}3 \approx 1\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 18\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {20\,\text{c}}{4\,\text{c}}}\approx 18\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 14\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {23\,\text{c}}{2\,\text{c}}}\approx -14\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $2 * A \frac{1}{12} = \frac{A:L:s}3 \approx 2\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 10\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {26\,\text{c}}{2\,\text{c}}}\approx 10\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $2 * A \frac{1}{2} = A \approx 12\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $
        T'
            = 2\pi\sqrt{\frac{M - m}{k}}
            = 2\pi\sqrt{\frac{M}{k} \cdot \frac{M - m}{M}}
            = T\sqrt{\frac{M - m}{M}} =  T\sqrt{1 - \frac{m}{M}} \approx 1\,\text{с}.
    $
}
\solutionspace{120pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 18\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {20\,\text{c}}{2\,\text{c}}}\approx 18\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 10\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {26\,\text{c}}{6\,\text{c}}}\approx -5\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 14\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {26\,\text{c}}{2\,\text{c}}}\approx 14\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 10\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {25\,\text{c}}{6\,\text{c}}}\approx 5\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 20\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {21\,\text{c}}{6\,\text{c}}}\approx -20\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 14\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {22\,\text{c}}{6\,\text{c}}}\approx -7\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $2 * A \frac{1}{\sqrt 2} = A\sqrt{2} \approx 17\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \sin \omega t = A \sin \cbr{ \frac {2\pi}T t } = A \sin \cbr{ 2\pi \frac tT } = 16\,\text{см} \cdot \sin \cbr{ 2\pi \cdot \frac {25\,\text{c}}{4\,\text{c}}}\approx 16\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 18\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {22\,\text{c}}{4\,\text{c}}}\approx -18\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \sin \omega t = A \sin \cbr{ \frac {2\pi}T t } = A \sin \cbr{ 2\pi \frac tT } = 16\,\text{см} \cdot \sin \cbr{ 2\pi \cdot \frac {20\,\text{c}}{2\,\text{c}}}\approx 0\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $
        T = 2\pi\sqrt{\frac\ell {a + g}}, T = \frac {t}{N}
        \implies a + g = \ell \cdot \frac{4 \pi ^ 2}{T^2},
        a = \ell \cdot \frac{4 \pi ^ 2}{T^2} - g = \ell \cdot \frac{4 \pi ^ 2 N^2}{t^2} - g \approx -0{,}87\,\frac{\text{м}}{\text{c}^{2}},
        \text{вверх}.
    $
}
\solutionspace{120pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 12\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {26\,\text{c}}{6\,\text{c}}}\approx -6\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 12\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {22\,\text{c}}{2\,\text{c}}}\approx 12\,\text{см}.$
}
\solutionspace{80pt}
...
\answer{%
    $x = A \cos \omega t = A \cos \cbr{ \frac {2\pi}T t } = A \cos \cbr{ 2\pi \frac tT } = 20\,\text{см} \cdot \cos \cbr{ 2\pi \cdot \frac {24\,\text{c}}{2\,\text{c}}}\approx 20\,\text{см}.$
}
\solutionspace{80pt}
