...
\task{%
    ...
    После замены катушки индуктивность на другую частота стала равной $50\,\text{Гц}$.
    А какой станет частота собственных колебаний, если в контур установить
    обе эти катушки последовательно?
}
\answer{%
    \begin{align*}
...
\task{%
    ...
    После замены катушки индуктивность на другую частота стала равной $30\,\text{Гц}$.
    А какой станет частота собственных колебаний, если в контур установить
    обе эти катушки параллельно?
}
\answer{%
    \begin{align*}
    T &= 2\pi\sqrt{LC} \implies \nu = \frac 1T = \frac 1{2\pi\sqrt{LC}} \implies L = \frac1 {4\pi^2 \nu^2 C}, \\
    ...
    \nu_\text{паралл.}
            ...
            = \frac 1{2\pi\sqrt{\frac 1{4\pi^2 \nu_1^2 C + 4\pi^2 \nu_2^2 C}C}} = \\
     &= \frac 1{\sqrt{\frac 1{\nu_1^2 + \nu_2^2}}}
            = \sqrt{\nu_1^2 + \nu_2^2} = \sqrt{\sqr{40\,\text{Гц}} + \sqr{30\,\text{Гц}}} \approx 50{,}00\,\text{Гц}.
    \end{align*}
}
...
\task{%
    В колебательном контуре частота собственных колебаний $80\,\text{Гц}$.
    После замены катушки индуктивность на другую частота стала равной $70\,\text{Гц}$.
    А какой станет частота собственных колебаний, если в контур установить
    обе эти катушки последовательно?
}
\answer{%
...
\answer{%
    ...
    T &= \frac{2\pi}\omega \approx 523{,}6\,\text{мc}, \\
    C &= \frac 1{\omega^2 L} \approx 115{,}7\,\text{мФ}, \\
    q_{\max} &= \frac{\eli_{\max}}\omega  \approx 25{,}0\,\text{мКл}.
    \end{align*}
}
\solutionspace{80pt}
...
\task{%
    Электрический колебательный контур состоит
    из катушки индуктивностью $L$ и конденсатора ёмкостью $C$.
    Последовательно конденсатору подключают ещё один конденсатор емкостью $\frac13C$.
    Как изменится период свободных колебаний в контуре?
}
\answer{%
    $
...
\task{%
    Электрический колебательный контур состоит
    из катушки индуктивностью $L$ и конденсатора ёмкостью $C$.
    Последовательно конденсатору подключают ещё один конденсатор емкостью $2C$.
    Как изменится период свободных колебаний в контуре?
}
\answer{%
    $
...
\task{%
    Электрический колебательный контур состоит
    из катушки индуктивностью $L$ и конденсатора ёмкостью $C$.
    Параллельно конденсатору подключают ещё один конденсатор емкостью $2C$.
    Как изменится период свободных колебаний в контуре?
}
\answer{%
    $
...
\task{%
    В колебательном контуре частота собственных колебаний $60\,\text{Гц}$.
    После замены катушки индуктивность на другую частота стала равной $90\,\text{Гц}$.
    А какой станет частота собственных колебаний, если в контур установить
    обе эти катушки параллельно?
}
\answer{%
...
\task{%
    Электрический колебательный контур состоит
    из катушки индуктивностью $L$ и конденсатора ёмкостью $C$.
    Параллельно конденсатору подключают ещё один конденсатор емкостью $\frac12C$.
    Как изменится период свободных колебаний в контуре?
}
\answer{%
    $
...
\task{%
    Электрический колебательный контур состоит
    из катушки индуктивностью $L$ и конденсатора ёмкостью $C$.
    Последовательно конденсатору подключают ещё один конденсатор емкостью $3C$.
    Как изменится период свободных колебаний в контуре?
}
\answer{%
    $
...
\task{%
    Электрический колебательный контур состоит
    из катушки индуктивностью $L$ и конденсатора ёмкостью $C$.
    Последовательно конденсатору подключают ещё один конденсатор емкостью $\frac12C$.
    Как изменится период свободных колебаний в контуре?
}
\answer{%
    $
...
\answer{%
    ...
    T &= \frac{2\pi}\omega \approx 418{,}9\,\text{мc}, \\
    C &= \frac 1{\omega^2 L} \approx 74{,}1\,\text{мФ}, \\
    q_{\max} &= \frac{\eli_{\max}}\omega  \approx 20{,}0\,\text{мКл}.
    \end{align*}
}
\solutionspace{80pt}
...
\task{%
    Электрический колебательный контур состоит
    из катушки индуктивностью $L$ и конденсатора ёмкостью $C$.
    Параллельно конденсатору подключают ещё один конденсатор емкостью $\frac13C$.
    Как изменится период свободных колебаний в контуре?
}
\answer{%
    $
