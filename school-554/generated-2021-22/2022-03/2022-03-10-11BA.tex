...
\answer{%
    $E = h\frac c\lambda = e U \implies \lambda = \frac{hc}{eU} = \frac{6{,}626 \cdot 10^{-34}\,\text{Дж}\cdot\text{с} \cdot 3 \cdot 10^{8}\,\frac{\text{м}}{\text{с}}}{1{,}6 \cdot 10^{-19}\,\text{Кл} \cdot 89\,\text{В}} \approx 13{,}96\,\text{нм}.$
}
