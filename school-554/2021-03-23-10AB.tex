...
\answer{%
    ...
    \end{align*}
        ...
        Q
            ...
            &= \frac{\Delta V}2 \cdot \cbr{5 \cdot \cbr{42P_0 - \frac{P_0}{V_0} V} - \frac{P_0}{V_0} V} = \frac{\Delta V \cdot P_0}2 \cdot \cbr{5 \cdot 42 - 8\frac{V}{V_0}}.
        \end{align*}
        ...
        Т.е.
        чтобы вычислить $Q_+$ нам надо сложить $Q_+ = Q_{12} + Q_{2*}$.
