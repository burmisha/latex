...
\tasknumber{3}
\task{
    Какое количество теплоты необходимо для превращения воды массой $15{,}0\,\text{кг}$ при $t = 50\celsius$
    в пар при температуре $t_{ 100 } = 100\celsius$?
}
\answer{
    $
        Q
            = cm\Delta t + Lm
            = m\cbr{ c(t_{ 100 } - t) + L }
            = 15{,}0\,\text{кг} \cdot \cbr{ 4200\,\frac{\text{Дж}}{\text{кг}\cdot\text{К}}\cbr{ 100\celsius - 50\celsius } + 2{,}3\,\frac{\text{МДж}}{\text{кг}} }
            = 37{,}65\,\text{МДж}
    $
}
\solutionspace{120pt}
...
\answer{
    ...
    (c_1 + c_2)\theta &= c_1 t_1 + c_2 t_2,  \\
    \theta &= \frac{ c_1 t_1 + c_2 t_2 }{ c_1 + c_2 }
            = \frac{ 4200\,\frac{\text{Дж}}{\text{кг}\cdot\text{К}} \cdot 10\celsius + 400\,\frac{\text{Дж}}{\text{кг}\cdot\text{К}} \cdot 70\celsius }{ 4200\,\frac{\text{Дж}}{\text{кг}\cdot\text{К}} + 400\,\frac{\text{Дж}}{\text{кг}\cdot\text{К}} }
            \approx 15{,}2 \celsius.
    \end{align*}
}
