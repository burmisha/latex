...
\task{
    Изобразите график гармонических колебаний, амплитуда которых составляла бы
    $A = 1{,}0\,\text{см}$, а период $T = 10{,}0\,\text{с}$.
}
...
\answer{
    ...
    N &= \nu t = 40\,\text{кГц} \cdot10{,}0\,\text{мин} = 24000000\,\text{колебаний}.
    \end{align*}
}
\solutionspace{120pt}
...
\answer{
    $
        s
            = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu
            = 4 \cdot 2\,\text{см} \cdot 10{,}0\,\text{с} \cdot 6\,\text{Гц}
            = 4{,}8\,\text{м}
    $
}
\solutionspace{120pt}
...
\task{
    Изобразите график гармонических колебаний, амплитуда которых составляла бы
    $A = 30\,\text{см}$, а период $T = 10{,}0\,\text{с}$.
}
...
\answer{
    $
        s
            = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu
            = 4 \cdot 15{,}0\,\text{см} \cdot 40\,\text{с} \cdot 2\,\text{Гц}
            = 48{,}0\,\text{м}
    $
}
\solutionspace{120pt}
...
\task{
    Изобразите график гармонических колебаний, амплитуда которых составляла бы
    $A = 15{,}0\,\text{см}$, а период $T = 4\,\text{с}$.
}
...
\answer{
    $
        s
            = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu
            = 4 \cdot 3\,\text{см} \cdot 40\,\text{с} \cdot 5\,\text{Гц}
            = 24{,}0\,\text{м}
    $
}
\solutionspace{120pt}
