...
\answer{%
    \begin{align*}
    \lambda &= c T \implies T = \frac{\lambda}c = \frac{3\,\text{см}}{3 \cdot 10^{8}\,\frac{\text{м}}{\text{с}}} = 1 \cdot 10^{-10}\,\text{с}, \\
    \lambda &= c T = c \cdot \frac 1\nu \implies \nu = \frac c{\lambda} = \frac{3 \cdot 10^{8}\,\frac{\text{м}}{\text{с}}}{3\,\text{см}} = 1 \cdot 10^{10}\,\text{Гц}.
    \end{align*}
}
\solutionspace{80pt}
...
\answer{%
    \begin{align*}
    \lambda &= c T \implies T = \frac{\lambda}c = \frac{3\,\text{м}}{3 \cdot 10^{8}\,\frac{\text{м}}{\text{с}}} = 1 \cdot 10^{-8}\,\text{с}, \\
    \lambda &= c T = c \cdot \frac 1\nu \implies \nu = \frac c{\lambda} = \frac{3 \cdot 10^{8}\,\frac{\text{м}}{\text{с}}}{3\,\text{м}} = 1 \cdot 10^{8}\,\text{Гц}.
    \end{align*}
}
\solutionspace{80pt}
