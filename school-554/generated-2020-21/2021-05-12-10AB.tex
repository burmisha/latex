...
\task{%
    ...
    $R_1 = 1\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 2\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
...
\task{%
    ...
    если сопротиваления всех резисторов равны: $R_1 = R_2 = R_3 = R_4 = R_5 = R_6 = R = 5\,\text{Ом}$,
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 2\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
...
\task{%
    ...
    если сопротиваления всех резисторов равны: $R_1 = R_2 = R_3 = R_4 = R_5 = R_6 = R = 10\,\text{Ом}$,
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 2\,\text{Ом}$, $R_4 = 3\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 1\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
...
\task{%
    ...
    если сопротиваления всех резисторов равны: $R_1 = R_2 = R_3 = R_4 = R_5 = R_6 = R = 2\,\text{Ом}$,
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 1\,\text{Ом}$, $R_4 = 3\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    ...
    если сопротиваления всех резисторов равны: $R_1 = R_2 = R_3 = R_4 = R_5 = R_6 = R = 4\,\text{Ом}$,
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 2\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 2\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 3\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 1\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 2\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 1\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 1\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 2\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 2\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 3\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 3\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 2\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 1\,\text{Ом}$, $R_4 = 3\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 4\,\text{Ом}$, $R_3 = 1\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 2\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 5\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 2\,\text{Ом}$, $R_2 = 3\,\text{Ом}$, $R_3 = 2\,\text{Ом}$, $R_4 = 2\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
...
\task{%
    Определите эквивалентное сопротиваление цепи на рисунке, если известны сопротивления резисторов:
    $R_1 = 1\,\text{Ом}$, $R_2 = 5\,\text{Ом}$, $R_3 = 3\,\text{Ом}$, $R_4 = 4\,\text{Ом}$.
    При каком напряжении поданном на эту цепь, в ней потечёт ток равный $\eli = 10\,\text{А}$?
