...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{0{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 4\,\text{c} }}2 = 0{,}5\,\text{м}, \\
...
\answer{%
    ...
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 28{,}8\,\text{м}.
    \\
...
\answer{%
    ...
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 21{,}6\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{2{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 4\,\text{c} }}2 = 12{,}5\,\text{м}, \\
...
\answer{%
    ...
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 23{,}4\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{0{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 3\,\text{c} }}2 = 0{,}4\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 2t}{t + 2t} = \frac{\frac{a t^2}2 + at \cdot 2t}{t (1 + 2)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 8{,}5\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 22{,}1\,\text{м}.
    \\
...
\answer{%
    ...
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 22{,}5\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{1{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 10\,\text{c} }}2 = 11{,}2\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 7{,}2\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 16{,}8\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{2\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 4\,\text{c} }}2 = 8{,}0\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 2t}{t + 2t} = \frac{\frac{a t^2}2 + at \cdot 2t}{t (1 + 2)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 12{,}8\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 25{,}6\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{0{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 10\,\text{c} }}2 = 1{,}2\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 8{,}5\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 16{,}9\,\text{м}.
    \\
    &v = \sqrt{v_x^2 + v_y^2} = \sqrt{v_{0x}^2 + \sqr{v_{0y} - g\tau}} = \sqrt{v_0^2 + \sqr{g\tau}} \approx 18{,}4\,\frac{\text{м}}{\text{c}}.
    \end{align*}
}
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{2{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 5\,\text{c} }}2 = 15{,}6\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 7{,}2\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 14{,}4\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{2\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 3\,\text{c} }}2 = 6{,}0\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{2\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 10\,\text{c} }}2 = 20{,}0\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 28{,}9\,\text{м}.
    \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 7{,}2\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 20{,}4\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{1{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 3\,\text{c} }}2 = 3{,}4\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 2t}{t + 2t} = \frac{\frac{a t^2}2 + at \cdot 2t}{t (1 + 2)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 11{,}2\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 24{,}0\,\text{м}.
    \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 11{,}2\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 27{,}0\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{1{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 4\,\text{c} }}2 = 4{,}5\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 7{,}2\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 18{,}0\,\text{м}.
    \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 12{,}8\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 22{,}4\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{2{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 3\,\text{c} }}2 = 9{,}4\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{0{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 5\,\text{c} }}2 = 0{,}6\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 14{,}4\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 25{,}5\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{1{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 2\,\text{c} }}2 = 2{,}2\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 14{,}4\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 23{,}8\,\text{м}.
    \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 12{,}8\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 20{,}8\,\text{м}.
    \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 12{,}8\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 19{,}2\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{0{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 2\,\text{c} }}2 = 0{,}2\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
...
\answer{%
    ...
    y &= y_0 + v_{0y}t - \frac{gt^2}2 = h - \frac{gt^2}2, \qquad y(\tau) = 0 \implies h - \frac{g\tau^2}2 = 0 \implies h = \frac{g\tau^2}2 \approx 8{,}5\,\text{м}.
    \\
    x &= x_0 + v_{0x}t = v_{0x}t \implies L = v_0\tau \approx 19{,}5\,\text{м}.
    \\
...
\answer{%
    ...
    s_x &= v_0t + \frac{a t^2}2 = \frac{a t^2}2 = \frac{1{,}5\,\frac{\text{м}}{\text{с}^{2}} \cdot \sqr{ 5\,\text{c} }}2 = 5{,}6\,\text{м}, \\
    v_\text{сред.} &= \frac{s_\text{общ}}{t_\text{общ.}} = \frac{s_x + v \cdot 3t}{t + 3t} = \frac{\frac{a t^2}2 + at \cdot 3t}{t (1 + 3)} = \\
