...
\answer{%
    ...
    \end{align*}
        ...
        \eta &= \frac{A_\text{цикл}}{Q_+} = \frac{A_\text{цикл}}{Q_{12} + Q_{2*}}
            ...
            &= \frac{\frac{25}2 \cdot P_0V_0}{0 + \frac{15}2 \cdot P_0 V_0 + \frac{1863}{128} \cdot P_0 V_0 + \frac{969}{32} \cdot P_0 V_0}
             = \frac{\frac{25}2}{\frac{15}2 + \frac{1863}{128} + \frac{969}{32}}
...
\answer{%
    ...
    \end{align*}
        ...
        \Delta U_{2*} &= \frac 32 \nu R T^* - \frac 32 \nu R T_2 = \frac 32 (P^*V^* - P_0 \cdot 5V_0)
            ...
            = \frac{169}8 \cdot P_0 V_0, \\
        \Delta U_{12} &= \frac 32 \nu R T_2 - \frac 32 \nu R T_1 = \frac 32 (5P_0V_0 - P_0V_0) = \ldots = 6 \cdot P_0 V_0, \\
        \eta &= \frac{A_\text{цикл}}{Q_+} = \frac{A_\text{цикл}}{Q_{12} + Q_{2*}}
            = \frac{A_\text{цикл}}{A_{12} + \Delta U_{12} + A_{2*} + \Delta U_{2*}} = \\
            &= \frac{8 \cdot P_0V_0}{0 + 6 \cdot P_0 V_0 + \frac{319}{32} \cdot P_0 V_0 + \frac{169}8 \cdot P_0 V_0}
             = \frac{8}{6 + \frac{319}{32} + \frac{169}8}
...
\answer{%
    ...
    \end{align*}
        ...
        \Delta U_{2*} &= \frac 32 \nu R T^* - \frac 32 \nu R T_2 = \frac 32 (P^*V^* - P_0 \cdot 3V_0)
            ...
            = \frac{15}2 \cdot P_0 V_0, \\
        \Delta U_{12} &= \frac 32 \nu R T_2 - \frac 32 \nu R T_1 = \frac 32 (3P_0V_0 - P_0V_0) = \ldots = 3 \cdot P_0 V_0, \\
        \eta &= \frac{A_\text{цикл}}{Q_+} = \frac{A_\text{цикл}}{Q_{12} + Q_{2*}}
            = \frac{A_\text{цикл}}{A_{12} + \Delta U_{12} + A_{2*} + \Delta U_{2*}} = \\
            &= \frac{2 \cdot P_0V_0}{0 + 3 \cdot P_0 V_0 + \frac{27}8 \cdot P_0 V_0 + \frac{15}2 \cdot P_0 V_0}
             = \frac{2}{3 + \frac{27}8 + \frac{15}2}
...
\answer{%
    ...
    \end{align*}
        ...
        \Delta U_{2*} &= \frac 32 \nu R T^* - \frac 32 \nu R T_2 = \frac 32 (P^*V^* - P_0 \cdot 4V_0)
            ...
            = \frac{433}{32} \cdot P_0 V_0, \\
        \Delta U_{12} &= \frac 32 \nu R T_2 - \frac 32 \nu R T_1 = \frac 32 (4P_0V_0 - P_0V_0) = \ldots = \frac92 \cdot P_0 V_0, \\
        \eta &= \frac{A_\text{цикл}}{Q_+} = \frac{A_\text{цикл}}{Q_{12} + Q_{2*}}
            = \frac{A_\text{цикл}}{A_{12} + \Delta U_{12} + A_{2*} + \Delta U_{2*}} = \\
            &= \frac{\frac92 \cdot P_0V_0}{0 + \frac92 \cdot P_0 V_0 + \frac{799}{128} \cdot P_0 V_0 + \frac{433}{32} \cdot P_0 V_0}
             = \frac{\frac92}{\frac92 + \frac{799}{128} + \frac{433}{32}}
...
\answer{%
    ...
    \end{align*}
        ...
        \Delta U_{2*} &= \frac 32 \nu R T^* - \frac 32 \nu R T_2 = \frac 32 (P^*V^* - P_0 \cdot 2V_0)
            ...
            = \frac{97}{32} \cdot P_0 V_0, \\
        \Delta U_{12} &= \frac 32 \nu R T_2 - \frac 32 \nu R T_1 = \frac 32 (2P_0V_0 - P_0V_0) = \ldots = \frac32 \cdot P_0 V_0, \\
        \eta &= \frac{A_\text{цикл}}{Q_+} = \frac{A_\text{цикл}}{Q_{12} + Q_{2*}}
            = \frac{A_\text{цикл}}{A_{12} + \Delta U_{12} + A_{2*} + \Delta U_{2*}} = \\
            &= \frac{\frac12 \cdot P_0V_0}{0 + \frac32 \cdot P_0 V_0 + \frac{175}{128} \cdot P_0 V_0 + \frac{97}{32} \cdot P_0 V_0}
             = \frac{\frac12}{\frac32 + \frac{175}{128} + \frac{97}{32}}
...
\answer{%
    ...
    \Delta U_{23} &= \frac 32 \nu R T_3 - \frac 32 \nu R T_2 = \frac 32 P_3 V_3 - \frac 32 P_2 V_2 = \frac 32 \cdot 6 P_0 \cdot 5 V_0 -  \frac 32 \cdot 6 P_0 \cdot V_0 = \frac 32 \cdot 24 \cdot P_0V_0, \\
    \Delta U_{12} &= \frac 32 \nu R T_2 - \frac 32 \nu R T_1 = \frac 32 P_2 V_2 - \frac 32 P_1 V_1 = \frac 32 \cdot 6 P_0V_0 - \frac 32 P_0V_0 = \frac 32 \cdot 5 \cdot P_0V_0.
    \\
    \eta &= \frac{A_\text{цикл}}{Q_+} = \frac{A_\text{цикл}}{Q_{12} + Q_{23}}  = \frac{A_\text{цикл}}{A_{12} + \Delta U_{12} + A_{23} + \Delta U_{23}} =  \\
     &= \frac{\frac 12 \cdot 20 \cdot P_0V_0}{0 + \frac 32 \cdot 5 \cdot P_0V_0 + 24P_0V_0 + \frac 32 \cdot 24 \cdot P_0V_0} = \frac{\frac 12 \cdot 20}{\frac 32 \cdot 5 + 24 + \frac 32 \cdot 24} = \frac4{27} \approx 0.148.
    \end{align*}
        ...
        \begin{tikzpicture}[thick]
            ...
            \draw[dashed] (0, 2) node[left] {$P_1 = P_0$} -| (3, 0) node[below] {$V_1 = V_2 = V_0$ };
            \draw[dashed] (0, 6) node[left] {$P_2 = P_3 = 6P_0$} -| (9, 0) node[below] {$V_3 = 5V_0$};
...
\answer{%
    ...
    \\
    \eta &= \frac{A_\text{цикл}}{Q_+} = \frac{A_\text{цикл}}{Q_{12} + Q_{31}}  = \frac{A_\text{цикл}}{A_{12} + \Delta U_{12} + A_{31} + \Delta U_{31}} =  \\
     &= \frac{\frac 12 \cdot 20 \cdot P_0V_0}{25P_0V_0 + \frac 32 \cdot 25 \cdot P_0V_0 + 0 + \frac 32 \cdot 5 \cdot P_0V_0} = \frac{\frac 12 \cdot 20}{25 + \frac 32 \cdot 25 + \frac 32 \cdot 5} = \frac17 \approx 0{,}143.
    \end{align*}
}
% autogenerated
