...
\tasknumber{4}%
\task{%
    Через резистор сопротивлением $R = 30\,\text{Ом}$ протекает электрический ток $\eli = 2{,}00\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli R = 2{,}00\,\text{А} \cdot 30\,\text{Ом} = 60\,\text{В},  \\
    P &= \eli^2R = \sqr{2{,}00\,\text{А}} \cdot 30\,\text{Ом} = 120\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
