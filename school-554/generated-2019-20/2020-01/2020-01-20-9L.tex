...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 10\,\text{см} \cdot 10\,\text{с} \cdot 2\,\text{Гц} = 8\,\text{м}$
}
\solutionspace{120pt}
...
\task{%
    Изобразите график гармонических колебаний,
    амплитуда которых составляла бы $A = 6\,\text{см}$, а период $T = 2\,\text{с}$.
}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 5\,\text{см} \cdot 10\,\text{с} \cdot 20\,\text{Гц} = 40\,\text{м}$
}
\solutionspace{120pt}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 3\,\text{см} \cdot 10\,\text{с} \cdot 5\,\text{Гц} = 6\,\text{м}$
}
\solutionspace{120pt}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 10\,\text{см} \cdot 40\,\text{с} \cdot 10\,\text{Гц} = 160\,\text{м}$
}
\solutionspace{120pt}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 2\,\text{см} \cdot 40\,\text{с} \cdot 20\,\text{Гц} = 64\,\text{м}$
}
\solutionspace{120pt}
...
\task{%
    Изобразите график гармонических колебаний,
    амплитуда которых составляла бы $A = 6\,\text{см}$, а период $T = 10\,\text{с}$.
}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 5\,\text{см} \cdot 80\,\text{с} \cdot 2\,\text{Гц} = 32\,\text{м}$
}
\solutionspace{120pt}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 15\,\text{см} \cdot 10\,\text{с} \cdot 10\,\text{Гц} = 60\,\text{м}$
}
\solutionspace{120pt}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 10\,\text{см} \cdot 10\,\text{с} \cdot 6\,\text{Гц} = 24\,\text{м}$
}
\solutionspace{120pt}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 15\,\text{см} \cdot 40\,\text{с} \cdot 10\,\text{Гц} = 240\,\text{м}$
}
\solutionspace{120pt}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 5\,\text{см} \cdot 80\,\text{с} \cdot 10\,\text{Гц} = 160\,\text{м}$
}
\solutionspace{120pt}
...
\task{%
    Изобразите график гармонических колебаний,
    амплитуда которых составляла бы $A = 40\,\text{см}$, а период $T = 6\,\text{с}$.
}
...
\answer{%
    $s = 4A \cdot N = 4A \cdot \frac tT = 4A \cdot t\nu = 4 \cdot 5\,\text{см} \cdot 40\,\text{с} \cdot 10\,\text{Гц} = 80\,\text{м}$
}
\solutionspace{120pt}
