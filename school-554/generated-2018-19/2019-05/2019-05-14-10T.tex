...
\answer{%
    \begin{align*}
    \eli &= \frac{V}{R} = \frac{240\,\text{В}}{30\,\text{Ом}} = 8\,\text{А},  \\
    P &= \frac{V^2}{R} = \frac{\sqr{240\,\text{В}}}{30\,\text{Ом}} = 1920\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\tasknumber{4}%
\task{%
    Лампочки, сопротивления которых $R_1 = 1\,\text{Ом}$ и $R_2 = 4\,\text{Ом}$, поочерёдно подключённные к некоторому источнику тока,
    потребляют одинаковую мощность.
    Найти внутреннее сопротивление источника и КПД цепи в каждом случае.
}
\answer{%
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $r = 12\,\text{Ом}$ протекает электрический ток $\eli = 8\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli r = 8\,\text{А} \cdot 12\,\text{Ом} = 96\,\text{В},  \\
    P &= \eli^2r = \sqr{8\,\text{А}} \cdot 12\,\text{Ом} = 768\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $r = 30\,\text{Ом}$ протекает электрический ток $\eli = 15\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli r = 15\,\text{А} \cdot 30\,\text{Ом} = 450\,\text{В},  \\
    P &= \eli^2r = \sqr{15\,\text{А}} \cdot 30\,\text{Ом} = 6750\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\answer{%
    \begin{align*}
    \eli &= \frac{V}{r} = \frac{180\,\text{В}}{12\,\text{Ом}} = 15\,\text{А},  \\
    P &= \frac{V^2}{r} = \frac{\sqr{180\,\text{В}}}{12\,\text{Ом}} = 2700\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $R = 5\,\text{Ом}$ протекает электрический ток $\eli = 6\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli R = 6\,\text{А} \cdot 5\,\text{Ом} = 30\,\text{В},  \\
    P &= \eli^2R = \sqr{6\,\text{А}} \cdot 5\,\text{Ом} = 180\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\answer{%
    ...
    Q_1 &= \eli_1^2R\tau = \sqr{\frac{\ele}{R}} R \tau
            = \sqr{\frac{3\,\text{В}}{30\,\text{Ом}}} \cdot 30\,\text{Ом} \cdot 10\,\text{с} = 3\units{Дж} \approx 3\,\text{Дж},  \\
    Q_2 &= \eli_2^2R\tau = \sqr{\frac{\ele}{R + r}} R \tau
...
\answer{%
    \begin{align*}
    \eli &= \frac{V}{r} = \frac{120\,\text{В}}{12\,\text{Ом}} = 10\,\text{А},  \\
    P &= \frac{V^2}{r} = \frac{\sqr{120\,\text{В}}}{12\,\text{Ом}} = 1200\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $R = 5\,\text{Ом}$ протекает электрический ток $\eli = 8\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli R = 8\,\text{А} \cdot 5\,\text{Ом} = 40\,\text{В},  \\
    P &= \eli^2R = \sqr{8\,\text{А}} \cdot 5\,\text{Ом} = 320\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\answer{%
    \begin{align*}
    \eli &= \frac{V}{R} = \frac{150\,\text{В}}{30\,\text{Ом}} = 5\,\text{А},  \\
    P &= \frac{V^2}{R} = \frac{\sqr{150\,\text{В}}}{30\,\text{Ом}} = 750\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $r = 18\,\text{Ом}$ протекает электрический ток $\eli = 10\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli r = 10\,\text{А} \cdot 18\,\text{Ом} = 180\,\text{В},  \\
    P &= \eli^2r = \sqr{10\,\text{А}} \cdot 18\,\text{Ом} = 1800\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\answer{%
    \begin{align*}
    \eli &= \frac{U}{R} = \frac{150\,\text{В}}{5\,\text{Ом}} = 30\,\text{А},  \\
    P &= \frac{U^2}{R} = \frac{\sqr{150\,\text{В}}}{5\,\text{Ом}} = 4500\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $r = 30\,\text{Ом}$ протекает электрический ток $\eli = 3\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli r = 3\,\text{А} \cdot 30\,\text{Ом} = 90\,\text{В},  \\
    P &= \eli^2r = \sqr{3\,\text{А}} \cdot 30\,\text{Ом} = 270\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\answer{%
    ...
    \eli_2 &= \frac{\ele}{R + r} = \frac{4\,\text{В}}{10\,\text{Ом} + 60\,\text{Ом}} = \frac2{35}\units{А} \approx 0{,}06\,\text{А},  \\
    Q_1 &= \eli_1^2R\tau = \sqr{\frac{\ele}{R}} R \tau
            = \sqr{\frac{4\,\text{В}}{10\,\text{Ом}}} \cdot 10\,\text{Ом} \cdot 10\,\text{с} = 16\units{Дж} \approx 16\,\text{Дж},  \\
    Q_2 &= \eli_2^2R\tau = \sqr{\frac{\ele}{R + r}} R \tau
    ...
    A_1 &= q_1\ele = \eli_1\tau\ele = \frac{\ele}{R} \tau \ele
            ...
            = 16\units{Дж} \approx 16\,\text{Дж}, \text{положительна},  \\
    A_2 &= q_2\ele = \eli_2\tau\ele = \frac{\ele}{R + r} \tau \ele
...
\answer{%
    ...
    Q_1 &= \eli_1^2R\tau = \sqr{\frac{\ele}{R}} R \tau
            = \sqr{\frac{3\,\text{В}}{10\,\text{Ом}}} \cdot 10\,\text{Ом} \cdot 10\,\text{с} = 9\units{Дж} \approx 9\,\text{Дж},  \\
    Q_2 &= \eli_2^2R\tau = \sqr{\frac{\ele}{R + r}} R \tau
    ...
    A_1 &= q_1\ele = \eli_1\tau\ele = \frac{\ele}{R} \tau \ele
            ...
            = 9\units{Дж} \approx 9\,\text{Дж}, \text{положительна},  \\
    A_2 &= q_2\ele = \eli_2\tau\ele = \frac{\ele}{R + r} \tau \ele
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $r = 12\,\text{Ом}$ протекает электрический ток $\eli = 15\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli r = 15\,\text{А} \cdot 12\,\text{Ом} = 180\,\text{В},  \\
    P &= \eli^2r = \sqr{15\,\text{А}} \cdot 12\,\text{Ом} = 2700\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\answer{%
    \begin{align*}
    \eli &= \frac{U}{R} = \frac{120\,\text{В}}{5\,\text{Ом}} = 24\,\text{А},  \\
    P &= \frac{U^2}{R} = \frac{\sqr{120\,\text{В}}}{5\,\text{Ом}} = 2880\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\tasknumber{2}%
\task{%
    Через резистор сопротивлением $r = 18\,\text{Ом}$ протекает электрический ток $\eli = 4\,\text{А}$.
    Определите, чему равны напряжение на резисторе и мощность, выделяющаяся на нём.
}
\answer{%
    \begin{align*}
    U &= \eli r = 4\,\text{А} \cdot 18\,\text{Ом} = 72\,\text{В},  \\
    P &= \eli^2r = \sqr{4\,\text{А}} \cdot 18\,\text{Ом} = 288\,\text{Вт}
    \end{align*}
}
\solutionspace{60pt}
...
\answer{%
    ...
    Q_1 &= \eli_1^2R\tau = \sqr{\frac{\ele}{R}} R \tau
            = \sqr{\frac{4\,\text{В}}{10\,\text{Ом}}} \cdot 10\,\text{Ом} \cdot 10\,\text{с} = 16\units{Дж} \approx 16\,\text{Дж},  \\
    Q_2 &= \eli_2^2R\tau = \sqr{\frac{\ele}{R + r}} R \tau
            = \sqr{\frac{4\,\text{В}}{10\,\text{Ом} + 10\,\text{Ом}}} \cdot 10\,\text{Ом} \cdot 10\,\text{с} = 4\units{Дж} \approx 4\,\text{Дж},  \\
    A_1 &= q_1\ele = \eli_1\tau\ele = \frac{\ele}{R} \tau \ele
            = \frac{\ele^2 \tau}{R} = \frac{\sqr{4\,\text{В}} \cdot 10\,\text{с}}{10\,\text{Ом}}
            = 16\units{Дж} \approx 16\,\text{Дж}, \text{положительна},  \\
    A_2 &= q_2\ele = \eli_2\tau\ele = \frac{\ele}{R + r} \tau \ele
