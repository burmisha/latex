...
# 13.78. Во сколько раз меньше нейтронов содержит ядро атома азота с массовым и зарядовым числами 14 и 7, чем ядро цинка с массовым и зарядовым числамн 65 и 30?
# 13.79. Ядро урана с массовым числом 239 и зарядовым числом 92, являясь радиоактивным, после испускания электрона превращается в ядро некоторого элемента. Каков порядковый номер этого элемента в периодической системе элементов Менделеева?
# 13.80. В реакции изотопа п А] и углерода 2 образуется альфа-частица, нейтрон и ядро некоторого изотопа. Определите количество нейтронов в образующемся ядре.
# 13.81. При бомбардировке лития SLi нейтронами образуется ядро гелия-4 и изотоп некоторого элемента. Определите количество нейтронов в ядре этого изотопа.
# 13.82. При бомбардировке нейтронами ядра атома алюминия 71 А1 испускается альфа-частица и образуется ядро некоторого изотопа. Определите количество нейтронов в ядре вновь образовавшегося изотопа.
# 13.83. Ядро изотопа бериллия 3Be, поглотив дейтон (изотоп водорода с массовым числом 2), превращается в ядро некоторого элемента. При этом испускается один нейтрон. Каков порядковый номер образовавшегося элемента в таблице Менделеева?
# 13.84. Когда ядро атома алюминия захватывает альфа-частицу, то образуется нейтрон и радиоактивный изотоп некоторого элемента. При его распаде испускается позитрон. Каков порядковый номер элемента, образующегося при этом распаде? Порядковый номер алюминня 13.
# 13.85. После захвата нейтрона ядро изотопа урана 280 превращается в радиоактивный изотоп урана, который после двух последовательных бета-распадов превращается в плутоний. Сколько нейтронов содержит ядро атома плутония?
# 13.86. В цепочке радиоактивных превращений после 5 бета-распадов и нескольких альфа-распадов ядро тяжелого элемента превращается в ядро устойчивого атома, порядковый номер которого на 13 меньше первоначального. На сколько меньше первоначального становится массовое число ядра?
# 13.87. В цепочке радиоактивных превращений после нескольких альфа- и бета-распадов ядро некоторого тяжелого атома превращается в ядро устойчивого атома, у которого число нейтронов на 27 меньше, чем у первоначального ядра. Известно, что число альфа-распадов равно числу бета-распадов. Чему равно общее число распадов?
# 13.88. Ядро некоторого элемента Х захватывает альфа-частицу. При этом испускается нейтрон и образуется ядро элемента У. Это ядро в свою очередь распадается с испусканием позитрона, образуя ядро элемента 7. Определите, на сколько больше нейтронов в ядре элемента 2, чем в первоначальном ядре Х.
# 13.89. За время 150 с распалось 7/8 первоначального числа радиоактивных ядер. Чему равен период полураспада этого элемента?
