...
# @variant.text('''
#     Полная энергия релятивистской частицы в 5 раз больше ее энергии покоя.
...
# @variant.text('''
#     Кинетическая энергия частицы космических лучей B3 раза превышает ее энергию покоя.
...
@variant.text('''
    Стержень движется в продольном направлении с постоянной скоростью относительно инерциальной системы отсчета.
    При каком значении скорости (в долях скорости света) длина стержня в этой системе отсчета
...
@variant.text('''
    Какую скорость должно иметь движущееся тело, чтобы его продольные размеры уменьшились в два раза? Скорость света 3.10% м/с.
''')
@variant.solution_space(80)
@variant.arg(A=('A = {} a', [1]))
@variant.answer_align([
...
@variant.text('''
    Время жизни мюона, измеренное наблюдателем, относительно которого мюон покоился, равно fo
     Какое расстояние пролетит мюон в системе отсчета, относительно которой он движется со скоростью V,
     сравнимой со скоростью света в вакууме с?
''')
@variant.solution_space(80)
@variant.arg(A=('A = {} a', [1]))
@variant.answer_align([
...
@variant.text('''
    Если с - скорость света в вакууме, то с какой скоростью должна двигаться нестабильная частица относительно наблюдателя,
    чтобы ее время жизни было в 10 раз больше, чем у такой же, но покоящейся относительно наблюдателя частицы?
''')
@variant.solution_space(80)
@variant.arg(A=('A = {} a', [1]))
@variant.answer_align([
