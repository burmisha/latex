...
# Атом водорода (25—26)
# 13.73. Во сколько раз уменьшается радиус орбиты электрона в атоме водорода, если при переходе атома из одного стационарного состояния в другое кинетическая энергия электрона увеличивается в 16 раз?
# 13.74. Во сколько раз увеличилась кинетическая энергия электрона в атоме водорода при переходе из одного стационарного состояния в другое, если угловая скорость вращения по орбите увеличилась в 8 раз?
# 13.75. Во сколько раз увеличивается угловая скорость вращения электрона в атоме водорода, если при переходе атома из одного стационарного состояния в другое радиус орбиты электрона уменьшается в 4 раза?
# 13.76. Переход атомов водорода из состояния с номером 2 в нормальное состояние сопровождается ультрафиолетовым излучением с некоторой длиной волны. Каков номер возбужденного состояния, в которое переходят атомы водорода из состояния с номером 2 при поглощении кванта с длиной волны, в 4 раза большей?
# 13.77. Каков номер возбужденного состояния, в которое переходит атом водорода из нормального состояния при поглощении фотона, энергия которого составляет 8/9 энергии ионизации атома водорода?
