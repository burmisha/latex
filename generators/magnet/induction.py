...
@variant.text('''
	...
	с {I1:V:e} до {I2:V:e} за {t:V:e}. Опредилите ЭДС самоиндукции, ответ выразите в мВ и округлите до целых.
''')
@variant.arg(I1=('\\eli_1 = {} А', [1, 2, 3, 4]))
@variant.arg(I2=('\\eli_2 = {} А', [7, 8, 9]))
